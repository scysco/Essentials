...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/scysco/Essentials/blob/main/computer-science/graph-theory/rutas_festival/src/rutas_festival.ipynb)
...
![Grafo del Festival Original](./assets/grafo_festival_original.png)

### Grafo Modificado (Sí Euleriano)

_Al añadir el sendero ZG-EL (en azul), todos los nodos tienen grado par._
![Grafo del Festival Modificado](./assets/grafo_festival_modificado.png)
